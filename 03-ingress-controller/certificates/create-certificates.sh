...
openssl req -x509 -newkey rsa:2048 -keyout certificates/portal-key.pem -out certificates/portal-cert.pem -nodes -subj "_//CN=${PORTAL_NETWORK_PORTALHOST}" -days 365
